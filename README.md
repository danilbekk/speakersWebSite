...
- ✅ Авторизация и регистрация
- ✅ Вывод данных диктора в личном кабинете
- ✅ Возможность добавления комментариев 
- ✅ Модель и контроллер рейтинга
- ✅ Возможность поставить рейтинг клиентами диктору
- ✅ Группировка дикторов по полу и сортировка по цене
- ✅ Поиск диктора по имени и фамилии
